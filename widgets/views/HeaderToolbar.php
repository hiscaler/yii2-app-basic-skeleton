    ...
    <ul class="nav navbar-top-links navbar-right">
        <li class="dropdown">
            <a class="dropdown-toggle count-info" data-toggle="dropdown" href="#">
                <i class="fa fa-envelope"></i>  <span class="label label-warning"><?= $ordersCount ?></span>
            </a>
                ...
                <?php foreach ($orders as $order): ?>
                    <li>
                        <div class="dropdown-messages-box">
                            ...
                            <div>
                                <small class="pull-right"><?= $order['sn'] ?></small><br>
                                <strong><?= $order['nickname'] ?></strong>
                                <small class="text-muted"><?= $formatter->asDatetime($order['created_at']) ?></small>
                            </div>
                        </div>
                    </li>
                    <li class="divider"></li>
                ...
                <li>
                    <div class="text-center link-block">
                        <a href="<?= Url::toRoute(['users/index']) ?>">
                            <i class="fa fa-envelope"></i> <strong>查看所有用户</strong>
                        </a>
                    </div>
                </li>
            </ul>
